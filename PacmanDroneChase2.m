...
pacman.speed = 1/8;         % pacman speed (default: 1/6 => pacman eats exactly two coins with every mouth open/close cycle, maximum possible: 1/2)
...
%% Initialize Ghosts
enemies(1).pos = [11.5, 20];            % ghost position
...
%         end
    ...
    function enemyRefresh % handles status and appearance of all ghosts 
        ...
        for nn = 1:2 % consider one ghost at a time
